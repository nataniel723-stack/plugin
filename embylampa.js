(function() {
    ...
    function embyPlayer(component, object) {
        ...
        let filter = new Lampa.Filter(object); // Создание фильтра внутри компонента

        this.initialize = function() {
            files.appendFiles(scroll.render());
            files.appendHead(filter.render()); // Добавление фильтра в заголовок
            ...
            findInEmby(movie, (item) => {
                ...
                if (item.Type === 'Series') {
                    ...
                    getSeasons(item.Id, (seasons) => {
                        ...
                        filter.set('season', seasonOptions); // Установка фильтров
