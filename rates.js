	...
	function rating_kp_imdb(card) {
		...
		function _showRating(data) {
			if (data) {
				 ...
				 *
				 * ВАЖНО:
				 * Класс .rate НЕ удаляем.
				 * Меняем только содержимое второго div.
				 * =====================================================
				 */
				// TMDB
